...
**MERN Stack Developer · UI Animations · Full-Stack Engineering**
...
| Project | Description |
|---|---|
| **Movie Social App** | Social platform for tracking films — watchlists, friends, ratings, and progress |
| **UMAT Mock Test Platform** | Faithful replica of the UMAT entry test interface |
| **MERN E-Commerce Store** | Full-stack store with buyer, seller, and admin role separation |
| **GSAP Scroll Animations** | Collection of high-performance scroll-driven UI animation demos |
